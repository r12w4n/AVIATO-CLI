  ...
  <xsl:template match="/">
    <html lang="en">
      ...
      <body>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>AVIATO Scan Report<br/><small>Nmap<xsl:value-of select="/nmaprun/@version"/></small></h1>
        ...
        <footer class="footer">
          <div class="container">
            <p class="text-muted">
              ...
              Licensed under <a href="#">AVIATO</a>.<br/>
              Built by R12W4N(<a href="https://github.com/R12W4N">@R12W4N</a>).<br/>
            </p>
          </div>
        </footer>
      </body>
